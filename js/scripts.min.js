...
$(function(){$(".slider").slick({arrows:!1}),$(".tab-content__item").not(":first").hide(),$(".types__inner .tab-title").click(function(){$(".types__inner .tab-title").removeClass("active").eq($(this).index()).addClass("active"),$(".slider").slick("unslick"),$(".tab-content__item").hide().eq($(this).index()).fadeIn(),$(".slider").slick({arrows:!1})}).eq(0).addClass("active"),$("#camer-count").range2DSlider({height:8,className:"form-slider",showLegend:!1,axis:[[1,32]],value:[[6]],template:"horizontal",tooltip:["bottom"],round:!0,onlyGridPoint:!0}),$("#save-data").range2DSlider({height:8,className:"form-slider",showLegend:!1,value:[[3]],axis:[[1,6]],template:"horizontal",tooltip:["bottom"],round:!0,onlyGridPoint:!0}),$(".faq__answer").hide(),$(".faq__title").click(function(){$(".faq__question.active").removeClass("active").find(".faq__answer").hide(),$(this).parent().parent().toggleClass("active").find(".faq__answer").toggle()})});